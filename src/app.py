...
activities = {
    ...
    "Track Team": {
        "description": "Train for sprints, relay races, and endurance events",
    ...
    "Drama Society": {
        "description": "Act in plays, build stage confidence, and develop performance skills",
    ...
    "Debate Club": {
        "description": "Strengthen critical thinking and public speaking skills",
